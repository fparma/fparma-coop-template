...
private _isPLT = _type == "PLT" || _type = "B_Officer_F";

switch (true) do {

    case (_isPLT); // fall through to SQL
    case (_type == "SQL" || _type = "B_soldier_SL_F"): {
        private _h = if (_isPLT) then {_PLT_HEADGEAR} else {_SQL_HEADGEAR};
    ...
    case (_type == "MEDIC" || _type = "B_medic_F"): {
    ...
    case (_type == "RIFLEMAN" || _type == "B_Soldier_F"): {
    ...
    case (_type == "AR" || _type == "B_soldier_AR_F") {
    ...
    case (_type == "ARASS" || _type == "B_soldier_AAR_F"): {
    ...
    case (_type == "AT" || _type == "B_soldier_AT_F"): {
    ...
    case (_type == "ATASS" || _type == "B_soldier_AAT_F"): {
        [_unit, [_COMMON_UNIFORMS, _COMMON_VESTS, _COMMON_HEADGEARS, _COMMON_BP]] call FP_fnc_addContainers;
    ...
    case (_type == "RAT" || _type == "B_soldier_LAT_F"): {
    ...
    case (_type == "MARKSMAN" || _type == "B_soldier_M_F"): {
        [_unit, [_COMMON_UNIFORMS, _COMMON_VESTS, _COMMON_HEADGEARS]] call FP_fnc_addContainers;
    ...
    case (_type == "GL" || _type == "B_Soldier_GL_F"): {
    ...
    case (_type == "ENGINEER" || _type == "B_engineer_F"): {
    ...
    case (_type == "PILOT" || _type == "B_Helipilot_F"): {
    ...
    case (_type == "CREW" || _type == "B_crew_F"): {
    ...
    default {if (!isNil "FP_gear_errs") then {FP_gear_errs pushBack format ["%1 - NOT FOUND KIT: %2", str _unit, _type]}};
};
...
if (_type != "CREW") then {
  ...
  [_unit, ["ItemRadio", "ACE_fieldDressing", "ACE_fieldDressing", "ACE_Morphine", "ACE_Flashlight_MX991", "ItemMap","ItemCompass","ItemWatch", "ItemGPS"]] call FP_fnc_addToContainers;
};
