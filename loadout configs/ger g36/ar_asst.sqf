...
_unit addItemToUniform "hlc_30rnd_556x45_Tracers_G36";
...
// Backpack items
{_unit addItemToBackpack "hlc_30rnd_556x45_EPR_G36"} count [1,2];
{_unit addItemToBackpack "CUP_100Rnd_TE1_Red_Tracer_556x45_BetaCMag"} count [1,2,3,4,5];
// Radios
